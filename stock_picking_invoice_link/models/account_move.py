...
class AccountMove(models.Model):
    ...
    receipt_number = fields.Char("Receipt Number",compute="_compute_picking_ids")
    receipt_date = fields.Date("Receipt Date",compute="_compute_picking_ids")
    ...
    def _compute_picking_ids(self):
        for invoice in self:
            ...
            invoice.receipt_number = ','.join(picking.name for picking in invoice.picking_ids)
            invoice.receipt_date = invoice.picking_ids[-1].scheduled_date if invoice.picking_ids else False
